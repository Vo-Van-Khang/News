    ...
    @csrf
        ...
        <div class="item">
            ...
            <div>
                ...
                <input type="text" name="username" placeholder="Nhập tên của bạn" value="{{old('username')}}">
            </div>
            @error('username')
        ...
        <div class="item">
            ...
            <div>
                ...
                <input type="password" name="password" placeholder="Nhập mật khẩu của bạn" value="{{old('password')}}">
            </div>
            @error('password')
                <p class="error" style="color:red;">{{$message}}</p>
            @enderror
        ...
        <div class="item">
            ...
            <div>
                <i class="fa-solid fa-lock"></i>
                <input type="password" name="password_confirmation" placeholder="Nhập lại mật khẩu của bạn" value="{{old('password_confirmation')}}">
            </div>
        ...
        <div class="item">
            <label for="">Hình ảnh (không bắt buộc)</label>
            <div>
